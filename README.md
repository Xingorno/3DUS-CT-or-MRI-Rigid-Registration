...
<p align="justify"> We proposed a vessel-based 3DUS-CT/MRI rigid registration for liver tumour ablation. Our <a href="https://ieeexplore.ieee.org/abstract/document/9800921"> previous work </a> shows the way of collecting 3D US images. To achieve the 3D US-CT/MRI registration task, firstly, we trained a nnUNet model to automatically segment the vessels from 3D US and CT/MRI data. Next, the vessel surface models (point clouds) and centerlines are extracted by using the <a href="https://www.slicer.org/"> 3D Slicer </a> software. Lastly, the coarse-to-fine registration algorithm can help us align them together. The workflow is shown in Figure 1.
</p>

<div align="center">
  <img src="1_updated.png"  alt="3DLIVUS system" width="80%">
  <br>
  <a>Figure 1. Workflow of 3D US-CT/MRI registration</a>
</div>
